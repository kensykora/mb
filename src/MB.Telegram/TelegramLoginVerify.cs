...
namespace MB.Telegram
{
    ...
    /// </summary>
    public class TelegramLoginVerify : IDisposable
    {
        /// <summary>
        ...
        public TelegramLoginVerify(string token)
        {
        ...
        {
            if (_disposed) throw new ObjectDisposedException(nameof(TelegramLoginVerify));
